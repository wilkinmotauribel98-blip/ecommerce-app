...
export default function TrustBarSection({product, loading}){
  if (loading) {
    return(
      <section className="w-full mt-10 max-w-7xl m-auto" aria-label="Trust bar loading">
        <ul className="lg:flex border  rounded-xl bg-zinc-900">
  ...
  return(
    <section  className="w-full mt-10 m-auto">
      <ul className="lg:flex border border-zinc-600 rounded-xl bg-zinc-950">
