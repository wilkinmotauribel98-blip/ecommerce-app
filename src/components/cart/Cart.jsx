    ...
    >
     <div 
      ...
      >
         ...
         {
          total > 0 && <span className={`rounded-full text-black ${total > 99 ? '-right-5 -top-2.5 min-w-7 w-fit py-0.5   min-h-7 ' : '-right-4.5 -top-3 min-w-7 w-fit  min-h-6  py-0.5'} bg-emerald-500 absolute   z-10   text-center text-balance  h-auto`}>
