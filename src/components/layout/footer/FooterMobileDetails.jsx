    ...
    <>
      ...
      <Detail title="Customer Care" content={
        <ul aria-label="Customer Care Information">
          ...
          <li className='text-zinc-300' aria-label="Shipping & Delivery">
            <Link to="/shipping-delivery">Shipping & Delivery</Link>
          </li>
          <li className='text-zinc-300' aria-label="Returns & Refunds">
            <Link to="/returns-refunds">Returns & Refunds</Link>
          </li>
          <li className='text-zinc-300' aria-label="FAQs">
      ...
      <Detail title="Company" content={
        <ul aria-label="Company Information" >
          <li className='text-zinc-300' aria-label="About us">
            <Link to="/about">About us</Link>
          </li>
          <li className='text-zinc-300' aria-label="Careers">
            <Link to="/careers">Careers</Link>
          </li>
          <li className='text-zinc-300' aria-label="Press">
            <Link to="/press">Press</Link>
          </li>
          <li className='text-zinc-300' aria-label="Sustainability">
       ...
       <nav className='flex flex-col gap-2 border-b border-zinc-700 mb-2 pb-5' aria-label="Social Media Navigation" name="footer-social">
          ...
          <ul className='flex gap-4' aria-label="Social Media Links">
            <li className='text-zinc-300 w-min' aria-label="Instagram">
              <svg width="44" height="44" aria-hidden="true">
                <use href="/sprite-extra.svg#icon-instagram"></use>
              </svg>   
            </li>
            <li className='text-zinc-300 w-min' aria-label="YouTube">
              <svg className=" text-zinc-400 w-11 h-11 hover:text-gray-400 cursor-pointer">
                <use href="/sprite-extra.svg#icon-youtube"></use>
              </svg>
            </li>
            <li className='text-zinc-400 w-min' aria-label="Twitter">
              <svg className=" text-zinc-300  w-11 h-11 hover:text-gray-400 cursor-pointer">
                <use href="/sprite-extra.svg#icon-twitter"></use>
              </svg>
            </li>
            <li className='text-zinc-400 w-min' aria-label="Facebook">
              <svg className=" text-zinc-300  w-11 h-11 hover:text-gray-400 cursor-pointer">
                <use href="/sprite-extra.svg#icon-facebook"></use>
              </svg>    
            </li>
          </ul>
        </nav>
